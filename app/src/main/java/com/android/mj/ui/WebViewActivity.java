...
public class WebViewActivity extends UIActivity<ActivityWebviewBinding> implements View.OnClickListener {
    ...
    protected void init() {
        ...
        databinding.progressWebview.getWebView().loadUrl(url);
        databinding.progressWebview.setIWebChromClient(new IWebChromeClient(databinding.progressWebview) {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.refresh) {
            databinding.progressWebview.getWebView().reload();
        }
